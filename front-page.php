...
<section id="products">
    ...
    <div class="container">
        <svg class="d-none d-md-block" xmlns="http://www.w3.org/2000/svg" width="37" height="71" viewBox="0 0 37 71"
             fill="none">
    ...
    <div class="container h-100">
        <div class="row h-100 justify-content-between align-items-end">
            <div class="col-12 col-lg-5 ">
                <div class="title-group right-align">
                    <picture>
                        <source media="(max-width:650px)"
                                srcset="<?php echo get_template_directory_uri(); ?>/assets/images/Group45.png" class="">
                        <source media="(min-width:650px)"
                                srcset="<?php echo get_template_directory_uri(); ?>/assets/images/home-title-bg.png"
                                class="">
                ...
                <a href="#" data-bs-target="#painting-modal" data-bs-toggle="modal" class="delis-btn secondary mt-5">آپلود
                    نقاشی</a>
            </div>
            <div class="col-12 col-lg-6">
            ...
            <div class="row justify-content-between align-content-start">
                <div class="col-lg-5">
                    <div class="title-group right-align">
                        ...
                        <picture>
                            <source media="(max-width:650px)"
                                    srcset="<?php echo get_template_directory_uri(); ?>/assets/images/Group45.png"
                                    class="">
                            <source media="(min-width:650px)"
                                    srcset="<?php echo get_template_directory_uri(); ?>/assets/images/home-title-bg.png"
                                    class="">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/home-title-bg.png"
                                 class="img-fluid yellow-heart">
                        </picture>
                    </div>
                    <p>
                ...
                <div class="col-lg-6 text-start mt-5">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/Group212.svg"
                         ...
                         alt="">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/images/Delis-red-nails.png"
                         class="img-fluid yellow-img"
                         alt="">
                </div>
    ...
    <div class="position-relative">
        <div class="container">
            <div class="fruit w-100 h-100 position-relative">
                ...
                <div class="swiper pb-5" id="instagram-cards">
                    <div class="swiper-wrapper">
                        ...
                        <span dir="ltr" class="ms-2">
                            delis_dessert_
                        </span>
                                            <a class="stretched-link"
                                               href="<?php echo get_sub_field('post_link'); ?>"><img
