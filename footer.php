              ...
              <div class="row">
                  <div class="col-md-6">
                      <div class="link-Container position-relative d-flex flex-column col-6 col-md-12 ">
                          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/request.svg"
                               class="link-Image"/>
                          <a href="<?php echo home_url('story'); ?>" class="link-Text stretched-link"> قصه‌ی دلیس</a>
                      ...
                      <div class="link-Container position-relative d-flex flex-column col-6 col-md-12">
                          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/request.svg"
                               class="link-Image"/>
                          <a href="<?php echo home_url('faq'); ?>" class="link-Text stretched-link"> سوال‌های شما</a>
                          <div class="border-btm">
                          </div>
                      </div>
                  </div>
                  <div class="col-md-6">
                      <div class="link-Container position-relative d-flex flex-column col-6 col-md-12">
                          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/request.svg"
                               class="link-Image"/>
                          <a href="<?php echo home_url('history'); ?>" class="link-Text stretched-link">دسرهای دلیس</a>
                          <div class="border-btm">
                          </div>
                      </div>
                      ...
                      <div class="link-Container position-relative d-flex flex-column col-6 col-md-12">
                          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/request.svg"
                               class="link-Image"/>
                          <a href="<?php echo home_url('history'); ?>" class="link-Text stretched-link"> ارتباط با دلیس</a>
                          <div class="border-btm">
                          </div>
                      </div>
                  </div>
