...
<section id="contact-way" >
    <div class="container position-relative">
        <div class="row   align-content-center align-items-center" >
<div class="col-md-12">
    <img src="<?php echo get_template_directory_uri()?>/assets/images/heart-beat.svg" alt="" class="blink heart-beat d-none d-lg-block ">
</div>
            <div class="col-md-6 ">
                <h2>
           ...
           <div class="row icon-box py-3">
               ...
               <div class="col-lg-7 col-sm-12">                   <p>تهران، خیابان آذربایجان شرقی، پلاک 103</p>
               </div>
           </div>
               ...
               <div class="col-7">                   <p>care@solico-group.com</p>
               </div></div>
           </div>
            </div>
